...
<!-- adopted from https://beta.rstudioconnect.com/jjallaire/htmlwidgets-highcharter/htmlwidgets-highcharter.html#sales-by-category -->
...
dfitemsg %>%
  data_to_hierarchical(c("category", "subcategory"), "sales", rev(viridis(6))) %>%
  hchart(
    type = "treemap",
