...
shinyjster::shinyjster_js("
  ...
  function assert_page(idx, name) {
    ...
    assert_equal_qs('#section-row2_plotly .chart-title', 'Row 2 Plotly Title: ' + name);
    assert_equal_qs('#section-row2_plotly p', 'Row 2 Plotly Content: ' + name);
    assert_equal_qs('#section-row2_plotly .chart-notes', 'Plotly Caption: ' + name);
    assert_equal_qs('#section-row2_plotly svg .gtitle', name);
    ...
    assert_equal_qs('#section-p2r1_plot .chart-title', 'P2R1 plot Title: ' + name);
    assert_equal_qs('#section-p2r1_plot p', 'P2R1 plot Content: ' + name);
    assert_equal_qs('#section-p2r1_plot .chart-notes', 'Plot Caption: ' + name);
